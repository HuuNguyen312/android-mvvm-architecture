...
public class OpenSourceFragment extends BaseFragment<FragmentOpenSourceBinding, OpenSourceViewModel>
        implements OpenSourceNavigator {
    ...
    private void setUp() {
        mDataBiding.openSourceRecyclerView.setLayoutManager(mLayoutManager);
        mDataBiding.openSourceRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mDataBiding.openSourceRecyclerView.setAdapter(mOpenSourceAdapter);
    }

    private void subscribeToLiveData() {
        mOpenSourceViewModel.getOpenSourceItemsLiveData().observe(this,
                openSourceItemViewModels -> mOpenSourceAdapter.addItems(openSourceItemViewModels));
    }
}
